    ...
    return (
        <div className="fixed-action-btn">
            ...
            <ul>
                ...
                <li><Link to='/' className="btn-floating yellow darken-1"><i className="material-icons">format_quote</i></Link></li>
                <li><Link to='/' className="btn-floating green"><i className="material-icons">publish</i></Link></li>
